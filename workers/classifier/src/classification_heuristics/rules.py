...
PROFILE_PATHS = {
    ...
    "fpga_programmable_logic_soc": ("fpga_programmable_logic_soc", "category_3_electronics"),
...
PATH_TITLES = {
    ...
    "fpga_programmable_logic_soc": "Category 3 electronics / programmable logic / SoC review path",
...
CANDIDATE_RULES = {
    ...
    "fpga_programmable_logic_soc": (("3A001", "review_candidate"),),
