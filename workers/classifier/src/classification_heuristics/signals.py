...
SIGNAL_RULES = (
    ...
    SignalRule("gpu_identity", ("gpu_accelerator", "advanced_computing_hardware"), 8, ("gpu accelerator", "graphics processing unit", "gpu card")),
    ...
    SignalRule("radio", ("radio_wireless_device", "rf_microwave_component"), 6, ("radio transceiver", "wireless transceiver", "antenna", "modulation")),
    ...
    SignalRule("storage", ("storage_or_memory_device",), 7, ("storage device", "solid state drive", "ssd", "memory module", "flash memory")),
)
