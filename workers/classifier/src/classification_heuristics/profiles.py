...
PROFILE_CONTRACTS = {
    ...
    "secure_networking_hardware": ProfileContract(required_any=("networking", "high_speed_ethernet", "network_security"), minimum_positive_evidence=2),
    "encryption_or_crypto_device": ProfileContract(required_any=("crypto",)),
