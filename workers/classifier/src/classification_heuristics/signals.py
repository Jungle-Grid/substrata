...
SIGNAL_RULES = (
    ...
    SignalRule("networking", ("networking_hardware", "secure_networking_hardware"), 7, ("smartnic", "network interface card", "network adapter", "ethernet switch", "router", "traffic offload", "packet processing", "ethernet")),
    SignalRule("high_speed_ethernet", ("networking_hardware", "secure_networking_hardware"), 4, ("10gbe", "25gbe", "100gbe", "200gbe", "400gbe", "10 gb ethernet", "25 gb ethernet", "100 gb ethernet", "200 gb ethernet", "400 gb ethernet")),
    SignalRule("network_security", ("secure_networking_hardware",), 5, ("macsec", "tls offload", "ipsec", "vpn", "encrypted connectivity")),
    SignalRule("transport_security", ("secure_networking_hardware",), 2, ("tls offload", "mqtt over tls", "https transport", "tls transport")),
    SignalRule("crypto", ("encryption_or_crypto_device",), 8, ("hardware security module", "hsm", "cryptographic module", "cryptographic acceleration", "encryption appliance", "key management device", "secure key vault")),
    SignalRule("platform_security", ("firmware_or_security_software",), 2, ("secure boot", "remote attestation", "firmware signing", "signed firmware", "secure enclave", "encrypted bitstream", "bitstream encryption")),
