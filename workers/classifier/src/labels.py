...
SPEC_DISPLAY_NAMES = {
    ...
    "external_memory_interface": "External Memory Interface",
    "external_memory_interfaces": "External Memory Interfaces",
    "display_camera_interface": "Display/Camera Interface",
    ...
    "caam": "CAAM",
    "pkha": "Public Key Cryptography Engine",
    "symmetric_engine": "Symmetric Engine",
    "cryptographic_hash_engine": "Cryptographic Hash Engine",
    "rng4": "RNG4",
    "secure_key_management": "Secure Key Management",
    "inline_encryption_engine": "Inline Encryption Engine",
    "otfad": "OTFAD",
    "snvs": "SNVS",
    "zero_master_key": "Zero Master Key",
    "puf": "PUF",
    "encrypted_boot": "Encrypted Boot",
